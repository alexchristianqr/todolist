<template>
  <b-form-group class="pt-lg-0 pt-3">
    <div>
      <span class="mr-1">{{ $t('TodoList.footer.a') }}</span>
...
<!--      <span>Hecho por </span>-->
<!--      <a target="_blank" href="https://github.com/alexchristianqr">@alexchristianqr</a>-->
<!--      <span> con </span>-->
<!--      <span style="font-size: 18px; color: #dc3545!important">&hearts;</span>-->
    </div>
  </b-form-group>
</template>
